...
static BOOL MakeRoot(PPMdVariantHModel *self,unsigned int SkipCount,PPMState *p1);
static void ClearMask(PPMdVariantHModel *self);
...
static PPMContext *StateSuccessor(PPMState *self,PPMdVariantHModel *model);
static void SetStateSuccessorPointer(PPMState *self,PPMContext *newsuccessor,PPMdVariantHModel *model);
static PPMState *ContextStates(PPMContext *self,PPMdVariantHModel *model);
static void SetContextStatesPointer(PPMContext *self, PPMState *newstates,PPMdVariantHModel *model);
static PPMContext *ContextSuffix(PPMContext *self,PPMdVariantHModel *model);
static void SetContextSuffixPointer(PPMContext *self,PPMContext *newsuffix,PPMdVariantHModel *model);
static PPMState *ContextOneState(PPMContext *self);

static void InitPPMContext(PPMContext *self);
static void InitPPMContextWithContext(PPMContext *self,PPMState *pstats,PPMContext *shortercontext,PPMdVariantHModel *model);
static PPMContext *NewPPMContext(PPMdVariantHModel *model);
static PPMContext *NewPPMContextWithContext(PPMdVariantHModel *model,PPMState *pstats,PPMContext *shortercontext);

static void DecodeBinSymbol(PPMContext *self,PPMdVariantHModel *model);
static void DecodeSymbol1(PPMContext *self,PPMdVariantHModel *model);
static void UpdateContext1(PPMContext *self,PPMdVariantHModel *model,PPMState *state);
static void DecodeSymbol2(PPMContext *self,PPMdVariantHModel *model);
static SEE2Context *MakeEscFreq2(PPMContext *self,PPMdVariantHModel *model,int Diff);
static void UpdateContext2(PPMContext *self,PPMdVariantHModel *model,PPMState *state);
static void RescaleContext(PPMContext *self,PPMdVariantHModel *model);
...
static void RestartModel(PPMdVariantHModel *self)
{
	...
	self->RunLength=self->InitRL=-((MaxOrder<12)?MaxOrder:12)-1;

	self->MaxContext=self->MinContext=NewPPMContext(self); // AllocContext()
	...
	self->FoundState=ContextStates(self->MaxContext);
...
static void UpdateModel(PPMdVariantHModel *self)
{
	...
	RESTART_MODEL:
	StartPPMdVariantHModel(self,NULL);
	self->EscCount=0;
